...
int main(int argc, char **argv)
{
    ...
    int valor_saque = 0, total_existente = 0, total_sacado = 0, total_cedulas = 0, cedulas_abs = 0, verifica_saque = 0, verifica_abs;
        ...
        case 2:   // Menu do gerente
            do
            {
                ...
                case 1: // Valor total sacado
                    ...
                    else if ((total_sacado == 0) || (total_sacado == 1))
                    {
                    ...
                    else if ((total_sacado == 1) || (total_sacado == 0))
                    {
                        printf("real'.\n");
                    }
                    printf("\n\n----------------------------------------------------------------------------------------------------------------------------------\n\n");
                ...
                case 2: // Saldo existente
                    ...
                    else if ((total_existente == 0) || (total_existente == 1))
                    {
                    ...
                    else if ((total_existente == 1) || (total_existente == 0))
                    {
                        printf("real'.\n");
                    }
                    printf("\n\n----------------------------------------------------------------------------------------------------------------------------------\n\n");
                ...
                case 3: // Quantidade de cada cédula
                    ...
                    else if ((total_cedulas == 0) || (total_cedulas == 1))
                    {
                    ...
                    else if ((total_cedulas == 1) || (total_cedulas == 0))
                    {
                        printf("cedula'.");
                    }
                    printf("\n\n----------------------------------------------------------------------------------------------------------------------------------\n\n");
                        ...
                        case 1: // Abastecimento das cédulas de 1
                            ...
                            else if (nota_1 < 12800)
                            {
                                ...
                                if (nota_1 > 12800)
                                {
                                    ...
                                    printf("\nTente novamente informando uma quantidade de ate %d cedulas.\n", verifica_abs);
                                    printf("\n\n----------------------------------------------------------------------------------------------------------------------------------\n\n");
                                    system("pause");
                                    opc_menu = -1; // Retorna ao menu do abastecimento
                                    break;
