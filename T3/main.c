...
// opbjetivo: verificar se a conta corrente está de acordo com o formato (999.999-X)
...
// opbjetivo: Remover a pontução do cpf para verificar se é válido
...
{
    char novo_cpf[14], cpf_sem_pontucao[11];
...
// opbjetivo: incluir um cadastro por vez
// parametros: nenhum
// retorno: nenhum
void incluir()
{
...
// opbjetivo: mostrar os cadastros inclusos
// parametros: nenhum
// retorno: nenhum
void mostrar()
{
...
// opbjetivo: alterar o cpf ou conta corrente do cliente que nao realizou um saque
// parametros: nenhum
// retorno: nenhum
void alterar()
{
...
// opbjetivo: zerar as posições do cpf e conta corrente do cadastro para excluir
// parametros: indice que indica qual cadastro deve ser zerado
// retorno: nenhum
void zera_indice(int indice)
{
    for (int i = 0; i < 9; i++)
        clientes_conta[indice][i] = '0';
    clientes_conta[indice][9] = '\0';

    for (int i = 0; i < 14; i++)
        clientes_cpf[indice][i] = '0';
    clientes_cpf[indice][14] = '\0';
}

// opbjetivo: excluir o cadastro que não realizou nenhum saque
// parametros: nenhum
// retorno: nenhum
void excluir()
{
    ...
    if (cadastros > 0)
    {
        do
        {
            ...
            else
            {
                ...
                if (verifica_conta == 0 && i == cadastros)
                {
                    if (saques_realizados[indice_cliente][0] == 0)
                    {
...
// opbjetivo: escrever um valor numérico por extenso
...
// opbjetivo: distribuir a menor quantidade de cédulas possíveis para o saque
...
// opbjetivo: realizar o saque informando a conta corrente
// parametros: nenhum
// retorno: nenhum
void saque()
{
...
// opbjetivo: informar os valores sacados por cada cadastro
// parametros: nenhum
// retorno: nenhum
...
// opbjetivo: informar o saldo existente no caixa
// parametros: nenhum
// retorno: nenhum
...
// opbjetivo: informar a quantidade de cada cédula no caixa e o total
// parametros: nenhum
// retorno: nenhum
